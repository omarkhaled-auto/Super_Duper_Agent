...
/// <summary>
/// Validator for the UpdateBidderCommand.
/// </summary>
public class UpdateBidderCommandValidator : AbstractValidator<UpdateBidderCommand>
{
    private readonly IApplicationDbContext _context;

    public UpdateBidderCommandValidator(IApplicationDbContext context)
    {
        _context = context;
        ...
        RuleFor(x => x.CRNumber)
            ...
            .MustAsync(BeUniqueCRNumberForUpdate)
        ...
        RuleFor(x => x.PrequalificationStatus)
            .IsInEnum()
            .WithMessage("Invalid prequalification status.");
    }

    private async Task<bool> BeUniqueCRNumberForUpdate(UpdateBidderCommand command, string? crNumber, CancellationToken cancellationToken)
    {
        ...
        return !await _context.Bidders
            .AnyAsync(b => b.CRNumber == crNumber && b.Id != command.Id, cancellationToken);
    }
}
