...
{
    /// <inheritdoc />
    public partial class AlignSchemaColumns : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Adds ALL columns that entity configurations define but the initial
            // migration missed. All operations are idempotent (IF NOT EXISTS).

            migrationBuilder.Sql(@"
                DO $$
                BEGIN
                    -- =============================================
                    -- 1. clarifications: add assigned_to_id
                    -- =============================================
                    IF NOT EXISTS (
                    ...
                    -- =============================================
                    -- 2. tender_bidders: add missing timestamp columns
                    -- =============================================
                    IF NOT EXISTS (
                        SELECT 1 FROM information_schema.columns
                    ...
                    -- =============================================
                    -- 3. approval_levels: add updated_at
                    -- =============================================
                    IF NOT EXISTS (
                        SELECT 1 FROM information_schema.columns
                    ...
                    -- =============================================
                    -- 4. evaluation_state table (singular)
                    --    Config maps to 'evaluation_state' but initial migration
